...
fun ActiveTrackView.toBridgeMap(): Map<String, Any?> = mapOf(
  ...
  "resolved_artist_names" to resolvedArtistNamesJson?.let(::deserializeArtistNames),
  "resolved_album_artist_names" to resolvedAlbumArtistNamesJson?.let(::deserializeArtistNames),
  "album" to album,
  ...
  "track_total" to trackTotal,
  "disc_total" to discTotal,
