...
export function rntpToTrack(rt: RntpTrack): Track {
  ...
  return {
    ...
    channels: rt.channels as number | undefined,
    codec: rt.codec as string | undefined,
    codecProfile: typeof rt.codecProfile === 'string' ? rt.codecProfile : undefined,
    isAtmosJoc: typeof rt.isAtmosJoc === 'boolean' ? rt.isAtmosJoc : undefined,
