...
function sameTrack(a: Track | null, b: Track | null): boolean {
  ...
  return (
    ...
    a.codec === b.codec &&
    a.codecProfile === b.codecProfile &&
    a.isAtmosJoc === b.isAtmosJoc &&
...
export function usePlaybackSync(): void {
  ...
  // Widgets do not display progress. Android Auto's metadata and playback
  // clock are published directly by the native player, independent of React.
  useEffect(() => {
